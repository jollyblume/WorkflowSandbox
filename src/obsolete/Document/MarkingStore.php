...
class MarkingStore implements MarkingStoreInterface, ArrayCollectionInterface
{
    ...
    public function __construct(string $markingStoreId, array $elements = [], PropertyAccessorInterface $propertyAccessor = null)
    {
        $rules = [
            'name' => [
                'markingId',
        ...
        $this->initializeTrait($markingStoreId, $elements, $rules, $propertyAccessor);
    }
